...
if __name__=='__main__':
    ...
    conv_to_jsonl('./data/3rd/scut/Couch_GB1_188/test', './data/dink/scut_gb1_188_test.jsonl')
    conv_to_jsonl('./data/3rd/scut/Couch_GB1_188/train', './data/dink/scut_gb1_188_train.jsonl')
    conv_to_jsonl('./data/3rd/scut/Couch_GB1_188/val', './data/dink/scut_gb1_188_val.jsonl')